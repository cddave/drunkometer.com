...
function game() {
    ...
    function start() {
        if(!gameOver) {
			...
			else if(destroyed < 25 && destroyed >22)
				sessionStorage.setItem("score", c+8);
			else if(destroyed < 22 && destroyed >19)
				sessionStorage.setItem("score", c+6);
			else if(destroyed < 19 && destroyed >16)
				sessionStorage.setItem("score", c+4);
			else if(destroyed < 16 && destroyed >10)
				sessionStorage.setItem("score", c+3);
			else if(destroyed < 10)
				sessionStorage.setItem("score", c+1);
